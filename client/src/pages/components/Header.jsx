    ...
    <>
      <div className="bg-slate-400 p-4 flex justify-between items-center">
        ...
        <ul className="flex flex-wrap items-center justify-end gap-2 text-white font-semibold list-none">
          ...
          {/* --- IMPACT LINK --- */}
          <li className="hover:underline hover:scale-105 transition-all duration-150 bg-white rounded px-2 py-0.5">
            <Link to="/impact" className="font-semibold text-green-700">
              Impact 🇮🇳
            </Link>
          </li>
          ...
          <li className="hover:underline hover:scale-105 transition-all duration-150">
            <Link to="/leaderboard" className="hover:text-green-700">
              🏆 Leaderboard
            </Link>
          </li>
