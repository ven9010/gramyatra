...
const AdminDashboard = () => {
  ...
  // --- NEW STATE FOR IMPACT LEADERBOARD ---
  ...
  // --- NEW FUNCTION TO FETCH IMPACT DATA ---
        ...
        <>
          <div className="w-[35%] p-3 max-sm:w-full">
            <div className="flex flex-col items-center gap-4 p-3">
              ...
              {/* --- NEW SWADESHI IMPACT LEADERBOARD SECTION --- */}
              <div className="mt-6 p-4 border-2 border-green-600 rounded-lg bg-green-50 w-full">
                <h2 className="text-xl font-bold text-green-800 mb-3">
                  🇮🇳 Swadeshi Impact Leaderboard
                </h2>

                {impactData && impactData.length > 0 ? (
                  impactData.map((v, i) => (
                    <div key={i} className="flex justify-between border-b py-2 border-green-200">
                      <span className="text-gray-800 font-medium">{v.localPartnerVillage || v.packageDestination}</span>
                      <span className="font-bold text-green-700">
                        ₹{v.totalVillageEarnings}
                      </span>
                    </div>
                  ))
                ) : (
                  <p className="text-sm text-gray-500 italic">No impact data recorded yet.</p>
                )}
              </div>
              {/* ------------------------------------------------ */}
