...
const Profile = () => {
  ...
  // State for Personal Impact Stats
  const [impact, setImpact] = useState({ totalImpact: 0, trips: 0 });
  ...
  useEffect(() => {
    if (currentUser !== null) {
      ...
      fetch(`/api/impact/user/${currentUser._id}`)
        .then((res) => res.json())
          ...
          <div className="w-[40%] p-3 max-sm:w-full">
            <div className="flex flex-col items-center gap-4 p-3">
              ...
              <div className="w-full shadow-2xl rounded-lg p-3 break-all">
                ...
                <div className="mt-2 bg-green-100 border border-green-600 rounded-lg p-3 mb-3">
                  <p className="text-lg font-bold text-green-800">
                    🇮🇳 Swadeshi Impact
                  </p>
                  <p className="text-xl">
                    ₹{impact.totalImpact.toLocaleString()} sent to villages
                  </p>
                  <p className="text-sm text-green-700">
                    Across {impact.trips} journeys
                  </p>
                </div>
